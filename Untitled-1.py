    ...
    """)
            ...
            while True:
                try:
                    ...
                    prioridade = int(input(" Digite a prioridade do chamado (Baixo = 1, Média = 2, Elevado = 3): "))
...
""")
            ...
            confirmacao = input(" Você realmente tem certeza que deseja resolver chamados? (s/n): ").lower()
            if confirmacao == "s":
                time.sleep(0.5)
            ...
            while True:
                try:
                    numero = int(input("\n Digite o ID do usuário que deseja resolver o chamado: "))
                    carregando()
                    break
                except ValueError:
                    print(""" ________________________ 
...
""")
            ...
            if numero in chamados:
                chamado = chamados[numero]
                ...
                print(" Nenhuma dado foi encontrado no ID informado!")
            ...
            resolver_problema = input("Desejar resolver esse chamado? (s/n): ").lower()

            if resolver_problema == "s":
                chamados[numero]["status"] = "Resolvido"
                time.sleep(0.8)

                print("Chamado resolvido com sucesso!!!")
